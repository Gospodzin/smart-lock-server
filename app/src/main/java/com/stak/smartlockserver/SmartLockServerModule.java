...
@Module(
        library = true,
        injects = {RegistrationResource.class, SmartLockResource.class}
)
public class SmartLockServerModule {
    ...
    @Provides @Singleton public Dao<AuthToken, String> provideAuthTokenDao(ConnectionSource connectionSource){
        try {
